...
class TodoItem extends React.Component {
    render() {
        ...
        return (<div style={{color:this.props.color}}>{r}<button onClick={this.props.onClick}>click</button></div>);
    }
}
class App extends React.Component {
    ...
    render() {
        ...
        return (
            <div className="panel">
                father <TodoItem items={this.state.todos} color={this.state.color} onClick={this.toggleHandler}/>
